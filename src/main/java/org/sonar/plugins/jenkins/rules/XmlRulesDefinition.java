...
public final class XmlRulesDefinition implements RulesDefinition {
  ...
  public void define(Context context) {
    NewRepository repository = context
      .createRepository(CheckRepository.REPOSITORY_KEY, Jenkins.KEY)
      .setName(CheckRepository.REPOSITORY_NAME);

    new AnnotationBasedRulesDefinition(repository, Jenkins.KEY).addRuleClasses(false, CheckRepository.getCheckClasses());
